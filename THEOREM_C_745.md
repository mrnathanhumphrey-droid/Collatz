...
1. **Subdominant rate of convergence.** Empirically `S_k = 7/15 − (1/30)·(1/2)^k + O((1/4)^k)` certified through k=5 (multi-spectral onset at k=6 per W2 audit). The rate `(1/2)^k` is conjectured (R77 Conjecture 77.2) to be the second eigenvalue of an inter-level bilinear pair operator T_M; rigorous spectral identification of T_M is open.
