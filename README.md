...
**ε_14, ε_15 computed (2026-05-17):** ε_14 = +3.588e-03, ε_15 = +4.161e-03. Hadamard radius |ε_k|^{-1/k}: 1.5655 (k=13) → 1.4951 (k=14) → 1.4412 (k=15), inward by 0.054-0.071/step. Envelope ratio decelerating: 1.217 (k=13→14) → 1.160 (k=14→15). Sign pattern still + + − − − − − − − + + + + + +. Predicted asymptote 1.016 (rate 0.984); linear extrapolation suggests reached around k≈22-25.
